...
// pipeline: node configuration, port schemas, the message accessors, the
// data-type conversion rules, and the wire formats a publisher has to
// reproduce, currently PublishTimestampLayout.
//
